...
public class EstiloTablaRenderer extends DefaultTableCellRenderer {
    ...
    public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
        ...
        this.setBorder(null);
        this.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 1, 1, 1, new java.awt.Color(70, 166, 55)));
        
        if (row % 2 == 0) {
            componenete.setForeground(new Color(70, 166, 55));
        ...
        if (isSelected) {
            ...
            componenete.setBackground(new Color(242, 140, 15));

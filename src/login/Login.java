...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(237, 244, 242));
        ...
        txtUsuario.setForeground(new java.awt.Color(242, 142, 19));
        txtUsuario.setFont(new java.awt.Font("Trebuchet MS", 1, 14)); // NOI18N
        txtUsuario.setPlaceholder("USUARIO");
        panel1.add(txtUsuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 290, 240, 30));

        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/login/campo-usuario.png"))); // NOI18N
        panel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 280, -1, -1));

        txtPassword.setBorder(null);
        txtPassword.setForeground(new java.awt.Color(242, 142, 19));
        txtPassword.setFont(new java.awt.Font("Trebuchet MS", 1, 14)); // NOI18N
        txtPassword.setPlaceholder("CONTRASEÑA");
        panel1.add(txtPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 360, 240, -1));

        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/login/campo-contrasena.png"))); // NOI18N
        panel1.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 350, -1, -1));

        info.setFont(new java.awt.Font("Trebuchet MS", 0, 14)); // NOI18N
        info.setForeground(new java.awt.Color(242, 142, 19));
        ...
        btnVentas.setForeground(new java.awt.Color(242, 142, 19));
        ...
        btnVentas.setFont(new java.awt.Font("Britannic Bold", 0, 18)); // NOI18N
